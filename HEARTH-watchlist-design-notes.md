...
- 02/09 end: notes complete and pushed. Colour-scheme section added after Cathal sent a screenshot. The doubled-header suggestion was implemented in v469; the other suggestions remain unbuilt unless requested.
